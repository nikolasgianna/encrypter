    ...
    <div class="col-md-4 text-center">
        ...
        <div class="modal-body row">
            <div class="col-md-6 text-center">
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-secondary active">
                        <input type="radio" name="options" id="encFile" autocomplete="off" checked>File
                    </label>
                    <label class="btn btn-secondary">
                        <input type="radio" name="options" id="encText" autocomplete="off">Text
                    </label>
                </div>
            ...
            <div class="col-md-6 text-center">
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-secondary active">
                        <input type="radio" name="options" id="IVFile" autocomplete="off" checked>File
                    </label>
                    <label class="btn btn-secondary">
                        <input type="radio" name="options" id="IVText" autocomplete="off">Text
                    </label>
                </div>
            </div>
